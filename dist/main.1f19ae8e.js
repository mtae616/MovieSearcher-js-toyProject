...
var searchEl = document.querySelector('.material-icons');
...
function realsearch() {
  var barVal = document.querySelector('.search__bar').value;

  _axios.default.get('https://www.omdbapi.com/?i=tt3896198&apikey=117ae0ed&s=' + barVal).then(function (res) {
    var wrapperEl = document.querySelector('.content__wrapper');
    var i;
    ...
    var _loop = function _loop() {
      ...
      var linking = res.data.Search[i].imdbID;
